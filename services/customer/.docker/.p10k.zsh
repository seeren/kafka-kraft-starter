# Generated by Powerlevel10k configuration wizard on 2024-01-24 at 22:07 UTC.
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_PREFIX='%1F├─'
  ...
  # NEST_COLOR
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=08
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%250F'  # green foreground NEST_COLOR
      local   modified='%1F'  # yellow foreground NEST_COLOR
      local  untracked='%250F'  # blue foreground NEST_COLOR
      local conflicted='%1F'  # red foreground NEST_COLOR
    else
      # Styling for incomplete and stale Git status.
      local       meta='%f'  # default foreground
      local      clean='%250F'  # default foreground NEST_COLOR
      local   modified='%1F'  # default foreground NEST_COLOR
      local  untracked='%250F'  # default foreground NEST_COLOR
      local conflicted='%1F'  # default foreground NEST_COLOR
    fi
